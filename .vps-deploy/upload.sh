...
show_copy_paste_commands() {
  ...
  echo "scp /Users/smdhussain/Desktop/projects/Rose-Chemicals-main/src/services/api.js root@72.60.218.57:/root/Rose-Chemicals/src/services/api.js"
  echo ""
  echo "2️⃣  Upload seed.js:"
  echo "scp /Users/smdhussain/Desktop/projects/Rose-Chemicals-main/backend/seed.js root@72.60.218.57:/root/Rose-Chemicals/backend/seed.js"
  echo ""
  echo "3️⃣  Rebuild on VPS:"
  echo "ssh root@72.60.218.57 'cd /root/Rose-Chemicals && npm run build && pm2 reload ecosystem.config.js'"
  echo ""
  echo "4️⃣  Check status:"
  echo "ssh root@72.60.218.57 'pm2 status'"
  echo ""
  echo "5️⃣  View logs:"
  echo "ssh root@72.60.218.57 'pm2 logs rose-backend --lines 50'"
  echo ""
}
