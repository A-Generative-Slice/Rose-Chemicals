          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-hero-bg text-white py-3 px-6 rounded-lg font-semibold hover:bg-hero-bg-dark transition-colors duration-200 transform hover:-translate-y-0.5 hover:shadow-lg ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
