  ...
  return (
    <>
      <button 
        ...
        className="fixed right-6 bottom-6 bg-header-cta text-header-cta-text px-6 py-3 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
      >
        Request Quote
      </button>
