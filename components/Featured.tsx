...
const PRODUCTS = {
  ...
  brushes: [
    ...
    { id: 24, name: 'Black Iron Brush', price: '₹70', image: '/images/CLOTH BRUSH/104. BLACK IRON BRUSH-Rs 68.png' },
    { id: 25, name: 'Cloth Brush', price: '₹50', image: '/images/CLOTH BRUSH/116. 6606 CLOTH BRUSH-Rs 50.png' },
    ...
    { id: 40, name: 'Supreem Iron Brush', price: '₹70', image: '/images/CLOTH BRUSH/103. SUPREEM IRON BRUSH-Rs 68.png' },
